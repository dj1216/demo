<template>
  <div id="app"  v-swiperight="rightSlip">
    ...
    <div  v-transfer-dom>
      <div id="spinnerBox" v-show="loading">
        <div class="spinner">
  ...
  export default {
    ...
    data () {
      return {
        ...
        colors: '',
        r: true,
        hideTitle: ['home', 'sort', 'classify', 'newIndex', 'otherclassify', 'supergoods', 'supergoods2', 'goods', 'likegoods', 'materials', 'materials2', 'my', 'my1', 'my2', 'my3', 'super', 'team', 'mallMy', 'guide', 'mallSeller', 'fastrob', 'signIn', 'mallUnderGoodsDetails'],
        version: '',
        smart: ''
      }
    },
