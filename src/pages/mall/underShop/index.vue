<template>
	<div class="UnderIndex Bindex" :style="{paddingTop: h+'px'}">
		<div class="seach_main" style="height:0.9rem">
			<div class="home_seach">
				...
				<img v-if="!$isMallShop" style="width: .4rem;height: .4rem;margin-left: .3rem" src="../../../assets/mall/img/home/bottom/my.png"
				 alt="" @click="jumpTo({name: 'mallUnderMy'})">
			</div>
		</div>
		<div class="allBox">
		...
		<div class="mescrollBox" :style="{'bottom': $isMallShop ? '43px' : '0',paddingTop: h+'px'}">
		...
		methods: {
		  ...
		  goJump (name){
			...
			upCallback(page, mescroll) {
				this.$http.post('/mall/oto/shops-list', {
					lng: this.lon,
					lat: this.lat,
					disType: this.active,
					page: page.num
