  ...
  <div id="offOrders">
    ...
    <div class="mescrollBox">
      <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
        <div class="off-body">
          <div class="list-item" v-for="(item,i) in list" :key="i" @click="jumpTo({name: 'mallOffOrderDetails', query: {orderId: item.orderId}})">
            <div>
              <p>UID：{{item.uid}}</p>
...
export default {
  ...
  methods: {
    ...
    upCallback (page, mescroll) {
      apiHttp.underOffOrder(page.num).then(res => {
        if (res.code === 0) {
